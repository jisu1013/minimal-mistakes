...
![Untitled.png](./2021-05-09 스터디_/Untitled.png)

## Traditional ML Pipeline의 경우에는

node / link / graph에 대한 feature들을 각각 design하게 된다. 그리고 모든 training data에 대해서 feature들을 포함하게 된다.

![Untitled%201.png](./2021-05-09 스터디_/Untitled%201.png)
...
![Untitled%202.png](./2021-05-09 스터디_/Untitled%202.png)
...
![Untitled%203.png](./2021-05-09 스터디_/Untitled%203.png)
...
- **Engienvector centrality**
    ...
    node $v$가 중요하다는 것의 근거는 노드 $v$가 중요한 이웃 노드들 $u\in N(v)$로 둘러싸여져 있다는 것이다 !! node $v$의 centrality는 다음과 같이 modeling된다.

    ![Untitled%204.png](./2021-05-09 스터디_/Untitled%204.png)

    하지만 이렇게 model이 될 경우 Recursive한 형태를 띄게 되는데, 이 부분은 어떻게 해결할까 ???

    위 식을 다음과 같이 다시 적어볼 수 있다.

    ![Untitled%205.png](./2021-05-09 스터디_/Untitled%205.png)
    ...
    - **Betweenness Centrality**
        ...
        **다른 노드들 사이의 Shortest Paths에 많이 나타날 수록 그 노드는 중요하다고 할 수 있다.**
        ...
        ![Untitled%206.png](./2021-05-09 스터디_/Untitled%206.png)

    - **Closeness Centrality**

        **다른 노드들로 가는 Shortest Path의 길이가 짧을 수록 그 노드는 중요하다고 할 수 있다.**

        ![Untitled%207.png](./2021-05-09 스터디_/Untitled%207.png)
    ...
    ![Untitled%208.png](./2021-05-09 스터디_/Untitled%208.png)

    **Clustering coefficient는 Ego-network에서의 triangle들의 개수를 count**하는 것이다.

    ![Untitled%209.png](./2021-05-09 스터디_/Untitled%209.png)
    ...
    ![Untitled%2010.png](./2021-05-09 스터디_/Untitled%2010.png)
    ...
    ![Untitled%2011.png](./2021-05-09 스터디_/Untitled%2011.png)
