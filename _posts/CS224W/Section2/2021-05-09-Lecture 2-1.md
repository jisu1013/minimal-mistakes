...
![Untitled2.png](./images/Untitled2.png)
...
![Untitled3.png](./images/Untitled3.png)
...
- **Engienvector centrality**
    ...
    - **Betweenness Centrality**
        ...
        **다른 노드들 사이의 Shortest Paths에 많이 나타날 수록 그 노드는 중요하다고 할 수 있다.**
        ...
        ![Untitled6.png](./images/Untitled6.png)

    - **Closeness Centrality**

        **다른 노드들로 가는 Shortest Path의 길이가 짧을 수록 그 노드는 중요하다고 할 수 있다.**

        ![Untitled7.png](./images/Untitled7.png)
    ...
    ![Untitled8.png](./images/Untitled8.png)

    **Clustering coefficient는 Ego-network에서의 triangle들의 개수를 count**하는 것이다.

    ![Untitled9.png](./images/Untitled9.png)
    ...
    ![Untitled10.png](./images/Untitled10.png)
    ...
    ![Untitled11.png](./images/Untitled11.png)
